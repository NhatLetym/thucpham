<!doctype html>
<html lang="en" ng-app="myapp" ng-controller="phanhoicontroller">

<head>
    <title>Quan ly phan hoi</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    <h1>FEEDBACK MANAGEMENT FORM</h1>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="product.level">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
    ...
    <script src="/adminn/js/phanhoicontroller.js">

    </script>
</body>

</html><?php /**PATH C:\Users\MY PC\Desktop\tenduan\resources\views/admin/phanhoi.blade.php ENDPATH**/ ?>