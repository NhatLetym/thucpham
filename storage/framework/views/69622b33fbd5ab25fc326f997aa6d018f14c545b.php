...
<body>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="product.ten_kh">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="product.dia_chi">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
    ...
    <script src="/adminn/js/khachhangcontroller.js">

    </script>
</body>

</html><?php /**PATH C:\Users\MY PC\Desktop\tenduan\resources\views/admin/khachhang.blade.php ENDPATH**/ ?>